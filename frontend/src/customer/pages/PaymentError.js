        ...
        <div className="status-card fadeInUp">
          ...
          <div className="status-body">
            ...
            <p className="status-message">
              Your payment for Order #{orderId} could not be processed. This
              could be due to insufficient funds, expired session, or other
              payment issues.
            </p>
            ...
            <div
              className="payment-notice alert-danger"
              style={{
                marginTop: "20px",
            ...
            >
              You can try again with a different payment method or contact
