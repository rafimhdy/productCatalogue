...
Please provide payment instructions. Thank you!
    ...
    const loadMidtrans = () => {
        return new Promise((resolve, reject) => {
            ...
            s.async = true;
            s.setAttribute('data-client-key', process.env.REACT_APP_MIDTRANS_CLIENT_KEY || 'SB-Mid-client-your-client-key-here');
            s.onload = () => {
                midtransLoadedRef.current = true;
        ...
        <>
            ...
            <div className="payment-container" style={{ marginTop: '60px' }}>
                ...
                <div className="payment-grid">
                        ...
                        <div className="order-content">
                            <div className="order-info">
                                ...
                                <div className="order-info-group">
                                    ...
                                    <span className={`status-badge status-${orderDetails.status || 'pending'}`}>
                    ...
                    <div className="payment-card payment-methods-card fadeInUp" style={{ animationDelay: '0.2s' }}>
                        ...
                        <div className="payment-methods-content">
                            ...
                            <div
                                className={`payment-option ${selectedOption === 'midtrans' ? 'selected' : ''}`}
                            ...
                            >
                                ...
                                <div className="payment-option-info">
                                    ...
                                    <p className="payment-option-description">Credit Card, Bank Transfer, E-wallet, etc.</p>
                                </div>
                            ...
                            <div
                                className={`payment-option ${selectedOption === 'whatsapp' ? 'selected' : ''}`}
                            ...
                            >
                                ...
                                <div className="payment-option-info">
                                    ...
                                    <p className="payment-option-description">Contact us directly for payment instructions</p>
                                </div>
                                <div className="payment-option-radio"></div>
                            </div>
                                ...
                                >
                                    {processingPayment ? (
                                        <div style={{
                                            ...
                                            <span>Processing...</span> {/* Bungkus teks dalam span! */}
                                        </div>
                                    ) : (
                                        <>
                            ...
                            <div className="payment-notice notice-info">
                                Please complete your payment to process your order. If you have any questions, feel free to contact our customer support.
                            </div>
                        </div>
                    </div>
                </div>
